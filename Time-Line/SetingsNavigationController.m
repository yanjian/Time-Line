...
@interface SetingsNavigationController () <UIGestureRecognizerDelegate> {
	CGPoint startTouch;
...
@implementation SetingsNavigationController
...
- (void)moveViewWithX:(float)x {
	...
	CGFloat aa = abs(startBackViewX) / SetingsBackViewWidth;
	CGFloat y = x * aa;

	CGFloat lastScreenShotViewHeight = SetingsBackViewHeight;
